...
import loopmania.Buildings.DoggieHouseStrategy;
import loopmania.Buildings.ElanHouseStrategy;
...
import loopmania.Buildings.TreeStrategy;
import loopmania.Buildings.VampireCastleStrategy;
import loopmania.Buildings.VillageStrategy;
import loopmania.Buildings.ZombiePitStrategy;
import loopmania.Goals.AndComplex;
import loopmania.Goals.BossGoal;
import loopmania.Goals.ComplexGoal;
import loopmania.Goals.CycleGoal;
import loopmania.Goals.ExperienceGoal;
import loopmania.Goals.Goal;
import loopmania.Goals.GoldGoal;
import loopmania.Goals.OrComplex;
  ...
  private void loadEntity(LoopManiaWorld world, JSONObject currentJson, List<Pair<Integer, Integer>> orderedPath) {
    ...
    switch (type) {
      ...
      case "elan_house":
        ...
        break;
      case "sniper_tower":
        Building sniperTower = new Building(new SimpleIntegerProperty(x), new SimpleIntegerProperty(y),
            new SniperTowerStrategy());
        onLoad(sniperTower);
